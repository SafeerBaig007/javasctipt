...
const findDepartment = (req, res, next) => {
    try {
        const validationResult = departmentSchema.findDepartmentValidation.validate({ dept_number: req.params.dept_number });
        if (!validationResult.error) {
            next();
        }
        else {
...
const deleteDepartment = (req, res, next) => {
    try {
        const validationResult = departmentSchema.departmentSchemaValidation.validate({
